...
export class SolutionComponent implements OnInit {
  ...
  getStacktrace() {
    this.stacktraceService
      .getStacktrace(this.route.snapshot.params.stacktraceId)
      .subscribe((data) => {
  ...
  chosenSolution(solutionId: number): void {
    this.stacktraceService
      .chosenSolution(solutionId, this.route.snapshot.params.stacktraceId)
      .subscribe((data) => {
        window.location.reload();
      });
  }
  ...
  getAllSolutionsByStacktraceId(): void {
    this.solutionService
      .getAllSolutionsByStacktraceId(
        this.route.snapshot.params.stacktraceId,
        this.page,
        this.pageSize
      )
      .then((result: any) => {
